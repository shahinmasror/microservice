...
{
    public class CatelogDbSeed
    {

        static ProductManeger _productManeger = new ProductManeger();   

        public static  void Seed()
        {
            var product = _productManeger.GetFirstOrDefault(x => true);

            if (product == null)
            {

                _productManeger.Add(GetPreConfigureProduct());
            }
        }

        private static List<Product> GetPreConfigureProduct()
        {
